        ...
        <>
                ...
                >
                    ...
                    >
                        <div style={{ padding: '20px 20px 16px' }}>
                            ...
                            <h3 style={{ fontSize: 15, fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 600, color: '#e5e5e5', marginBottom: 8 }}>
                                Incomplete Shot Notes
                            </h3>
                            <p style={{ fontSize: 13, fontFamily: "'Inter', system-ui, sans-serif", color: '#888', lineHeight: 1.5, marginBottom: 16 }}>
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginBottom: 4 }}>
                                {SHOT_CATEGORIES.filter(c => !filledCats.has(c.id)).map(cat => (
                                    <span key={cat.id} style={{
                                        ...
                                        background: `${cat.color}12`, border: `1px solid ${cat.border}`,
                        ...
                        <div style={{
                            padding: '12px 20px 16px', borderTop: '1px solid #1e1e1e',
                            ...
                            <button onClick={() => setShowConfirm(false)} style={{
                                ...
                                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1a1a1a'; (e.currentTarget as HTMLElement).style.color = '#ddd'; }}
                            ...
                            <button onClick={doGenerate} style={{
                                padding: '7px 18px', borderRadius: 8, border: '1px solid rgba(249,115,22,0.4)',
                                background: 'rgba(249,115,22,0.12)', color: '#f97316', fontSize: 13,
                                fontFamily: "'Inter', system-ui, sans-serif", fontWeight: 600, cursor: 'pointer',
            ...
            {(result || error) && createPortal(
                ...
                >
                    <div
                        style={{
                            width: 420, borderRadius: 10,
                            border: `1px solid ${error ? '#3b1515' : '#1e3a2a'}`,
                            background: error ? '#120808' : '#0a1511',
                            boxShadow: error ? '0 16px 60px rgba(239,68,68,0.2)' : '0 16px 60px rgba(74,222,128,0.15)',
                            overflow: 'hidden', animation: 'modalScaleFade 200ms ease-out forwards',
                        }}
                        onClick={e => e.stopPropagation()}
                    >
                        <div style={{
                            padding: '8px 12px 6px', borderBottom: `1px solid ${error ? '#2a1010' : '#143d24'}`,
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                                {result && (
                                    <button onClick={(e) => { e.stopPropagation(); handleCopy(); }} onMouseDown={e => e.stopPropagation()}
                                        style={{
                                            background: copied ? 'rgba(74,222,128,0.15)' : 'transparent',
                                            border: `1px solid ${copied ? 'rgba(74,222,128,0.3)' : '#2a2a2a'}`,
                                            borderRadius: 5, color: copied ? '#4ade80' : '#888',
                                            fontSize: 10, fontFamily: "'JetBrains Mono', monospace",
                                ...
                                <button onClick={(e) => { e.stopPropagation(); setResult(null); setError(null); }} onMouseDown={e => e.stopPropagation()}
                        ...
                        <div style={{
                            padding: '10px 12px 12px', fontSize: 12,
                            fontFamily: "'Inter', system-ui, sans-serif", lineHeight: 1.6,
                            color: error ? '#ef4444' : '#ccc', maxHeight: 200, overflowY: 'auto',
                        ...
                        {result && (
                            <div style={{
                                padding: '4px 12px 8px', borderTop: '1px solid #143d24',
                                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                            }}>
